...
<head>
    ...
    <title>ASL : C&V Data, MB : GM</title>
    <style>
...
<?php
        ...
        } elseif ($approve_filter == 'approved') {
            $query .= " AND mv.approved_flag = 1";
        }
...
<form id="filterForm" method="GET" action="">
    ...
    <select name="approve_filter" id="approve_filter">
        ...
        <option value="approved" <?php if ($approve_filter == 'approved') echo 'selected'; ?>>Approved</option>
    </select>
    ...
    <?php echo"<a style='text-decoration: none;' href='completed-data.php' class='btn btn-success'>Completed Data</a>";?>
</form>
<!-- <form id="search">
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        // For the view
        echo "<a style='text-decoration: none;' href='view-data.php?cv_id=" . $row['cv_id'] . "' class='btn btn-success'>View</a>";
